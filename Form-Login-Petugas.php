        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div class="card card-primary">
              <div class="card-header"><h4>Login Petugas/Admin</h4></div>

              <div class="card-body">
                <form method="POST" action="cek_login.php" class="needs-validation" novalidate="">
                  <div class="form-group">
                    <label for="email">username</label>
                    <input id="username" type="text"  required="required" class="form-control" name="username" tabindex="1" required autofocus>
                  ...
                  <div class="form-group">
                    ...
                    <input id="password" type="password"  required="required" class="form-control" name="password" tabindex="2" required>
                    <div class="invalid-feedback">
                ...
                <div class="form-group">
                <a href="Form-Login.php"> <button  type="submit" class="btn btn-danger btn-lg btn-block" tabindex="4">
                    Siswa
                  </button></a>
