...
<div class="main-content">
  ...
  <div class="row">
    ...
    while($data = mysqli_fetch_array($sql)){
        ...
        echo"<td><a class='btn btn-primary' href='UpdateTransaksi.php?id_pembayaran=".$data['id_pembayaran']."'>Ubah</a>
                 <a class='btn btn-danger' href='HapusTransaksi.php?id_pembayaran=".$data ['id_pembayaran']."'>Hapus</a></td>";
        echo "</tr>";
    }
    ?>
    </table>
